import "./Grid.css";
import reviewerImage from "../assest/image/reviewerImage.avif";
import Ans from "./Ans";
  ...
  return (
    <div id="grid-container">
      {reviewData.map((elem, index) => {
        return (
          <Ans
            imgSrc={elem.reviewerImage}
            review={elem.review}
            reviewerName={elem.reviewerName}
            reviewerDesignation={elem.reviewerDesignation}
          />
        );
      })}
    </div>
